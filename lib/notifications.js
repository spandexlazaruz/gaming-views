...
// Exported (item 40 — keep released games visible in Watchlist for 24h):
// reused as-is by app/(tabs)/watchlist.js to resolve the same "which
// platform's date counts" question for its own 24-hour release grace
// window, rather than inventing a second date-selection rule — this is
// already the one place in the app that decides it.
export function reminderDateFor(game, platformContext) {
