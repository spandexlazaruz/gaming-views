...
export function WatchlistProvider({ children }) {
  ...
  const value = useMemo(
    () => ({ saved, toggleWatchlist, reminders, setReminderLead, preferredPlatform, setPreferredPlatform, preferredGenre, setPreferredGenre }),
    [saved, reminders, preferredPlatform, preferredGenre]
  );
