...
export function WatchlistProvider({ children }) {
  ...
  }, [hydrated, savedPlatforms, reminders, platformContext, savedGameSnapshots, calendarAdded, preferredPlatform, preferredGenre, weeklyDigestEnabled]);
  ...
  const value = useMemo(
    () => ({
      ...
      // seed its own local state from preferredPlatform/preferredGenre
    ...
    [saved, savedPlatforms, reminders, platformContext, savedGameSnapshots, calendarAdded, preferredPlatform, preferredGenre, weeklyDigestEnabled, hydrated]
  );
