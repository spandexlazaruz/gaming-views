...
export function WatchlistProvider({ children }) {
  ...
  }, [hydrated, savedPlatforms, reminders, platformContext, savedGameSnapshots, preferredPlatform, preferredGenre, weeklyDigestEnabled]);
  ...
  const value = useMemo(
    ...
    [saved, savedPlatforms, reminders, platformContext, savedGameSnapshots, preferredPlatform, preferredGenre, weeklyDigestEnabled, hydrated]
  );
