...
export default function GameCard({ game }) {
  ...
  const primaryPlat = game.platforms[0];
  ...
  return (
    ...
    >
      <LinearGradient colors={theme} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.thumb}>
...
const styles = StyleSheet.create({
  ...
  thumbTitle: { fontFamily: 'Poppins_700Bold', fontSize: 10, color: 'rgba(255,255,255,0.92)', textTransform: 'uppercase' },
